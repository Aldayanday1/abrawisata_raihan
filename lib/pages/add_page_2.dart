                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // _buildTextField(),
                            _buildTitle('IV. Biaya Operational'),
                            _buildLabelAndField('Gaji Karyawan'),
                            _buildLabelAndField('Biaya Sewa'),
                            _buildLabelAndField('Biaya Promosi & Iklan'),
                            _buildLabelAndField('Persediaan Akhir'),
                            _buildLabelAndField('Pembelian ATK'),
                            _buildLabelAndField('Transportasi'),
                            _buildLabelAndField('Biaya Perbaikan'),
                            _buildLabelAndField('Bunga Bank'),
                            _buildLabelAndField('Biaya Telepon'),
                            _buildLabelAndField('Listrik'),
                            _buildLabelAndField('Biaya Penyusutan'),
                            _buildLabelAndField('Biaya Lain-Lain'),
                            // _buildLabelAndField('Total HPP'),
                            _buildLabelAndField('Total Biaya Operational',
                                isTotal: true),
                            // _buildTitle('Total HPP', isBold: true),
                            // _buildTextField(),
                            _buildTitle('V. Laba Usaha (Sebelum Pajak)'),
                            _buildTextField(),
                            SizedBox(height: 15),
                            Row(
